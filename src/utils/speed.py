...
def get_k(region, theta, dot, r0, theta0):
    if region == 1:
        return tangent_slope_at_A(theta, r0)
    ...
    if region == 2:
        ...
        return tangent_slope_at_A(theta - math.pi,r0)
...
def get_speed(theta_1, r1, speed_1, region1, theta_2, r2, region2, r0, theta0, b):
    ...
    # print(region2)
    k_A1 = get_k(region1, theta_1, dot1, r0, theta0)
    k_A2 = get_k(region2, theta_2, dot2, r0, theta0)
